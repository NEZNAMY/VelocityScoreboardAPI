...
public class PacketRegistry {
    ...
    public static void registerPackets(@NotNull ProtocolVersion maximumSupportedVersion) throws Exception {
        ...
        register(clientbound,
                ...
                map(0x5C, ProtocolVersion.MINECRAFT_1_21_2, maximumSupportedVersion)
        );
        register(clientbound,
                ...
                map(0x64, ProtocolVersion.MINECRAFT_1_21_2, maximumSupportedVersion)
        );
        register(clientbound,
                ScorePacket.class,
                ScorePacket::new,
        ...
        register(clientbound,
                ...
                map(0x68, ProtocolVersion.MINECRAFT_1_21_2, maximumSupportedVersion)
        );
        register(clientbound,
                ...
                map(0x49, ProtocolVersion.MINECRAFT_1_21_2, maximumSupportedVersion)
        );
        register(clientbound,
                TeamPacket.class,
                TeamPacket::new,
                ...
                map(0x67, ProtocolVersion.MINECRAFT_1_21_2, maximumSupportedVersion)
        );
    }
